export default {
  ...
  aiGlossary: {
    ...
    anthropic: {
      ...
      subtitle: "以安全性和超长上下文见长的旗舰模型",
      definition: "模型家族概述（2026 年最新）",
      definitionContent: "Anthropic 的 Claude 系列专注于 AI 安全与可解释性，采用 Constitutional AI 训练方法。当前主要产品线（截至 2026.02）：\n\n• Claude Sonnet 4.6（2026-02-17）— 最新旗舰 Sonnet，代码/Agent/长上下文/Computer Use 全面提升，1M token 上下文（Beta），Free/Pro 计划默认模型\n• Claude Opus 4.6（2026-02-05）— 最强推理旗舰，大型代码库 Agent 任务、代码审查与调试能力显著提升，同样支持 1M token 上下文（Beta）\n• Claude Sonnet 4.5 — 上一代 Sonnet，仍被广泛使用，200K 上下文\n• Claude Haiku 4（claude-haiku-4-20251002）— 快速经济型，适合高并发场景\n• Claude 3.5 Sonnet / Haiku — 第三代产品线，众多第三方代理仍在支持",
      function: "核心能力",
      functionContent: "• 超长上下文：1M tokens Beta（Sonnet/Opus 4.6），支持整个大型代码仓库分析\n• 代码能力：SWE-bench 排名持续领先，Claude Code 的底层模型\n• Agent 长任务：Opus 4.6 可在大型代码库中稳定执行长时间 Agent 任务\n• Computer Use：Sonnet 4.6 的计算机操作能力大幅提升\n• 上下文压缩：引入 Context Compaction，自动压缩超长对话历史\n• 多模态：图像、PDF、文档统一分析\n• 工具使用：强大的 Function Calling / Tool Use，MCP 协议原生支持者",
      scenario: "典型使用场景",
      scenarioContent: "• Claude Code — 官方 AI 编程助手，claude-sonnet-4-6 / claude-opus-4-6 为核心模型\n• 大型代码库 Agent：Opus 4.6 适合跨文件重构、复杂 Bug 修复等长 Agent 任务\n• 超长文档分析：法律合同、学术论文、1M token 级别的巨型代码仓库\n• Agent 构建：MCP 协议推动者，适合工具密集型 Agent 系统\n• 内容创作：技术文章、营销文案、多语言翻译",
      relation: "与其他生态关系",
      relationContent: "• 是 MCP 协议的发起方，Claude Code/Gemini CLI/Codex 均支持 MCP\n• claude-sonnet-4-6 是本平台 Claude Code Provider 的推荐目标模型\n• Anthropic API 兼容 OpenAI 接口格式，多数中转代理（如 Kimi、PackyCode）均适配\n• Context Compaction 功能需 claude.ai 客户端或 Claude Code v1.x 支持",
    },
    openai: {
      title: "OpenAI GPT / o / Codex 系列",
      subtitle: "最广泛采用的通用大模型（2026 最新）",
      definition: "模型家族概述（2026 年最新）",
      definitionContent: "OpenAI 产品线持续扩展，截至 2026.02 主要包括：\n\n【GPT-5 系列（通用旗舰）】\n• GPT-5（2025-08）— 当前最强通用模型，内置 Chain-of-Thought 思考，多模态（文本/图像/音频），支持专家级推理\n• GPT-5 mini — 轻量版 GPT-5，大幅降低成本，仍具备强推理能力\n• GPT-4o — 上一代多模态旗舰，仍被广泛使用\n\n【o 系列（推理增强型）】\n• o3（2025-04）— 旗舰推理模型，数学/代码/科学顶尖，支持 o3-pro 深度推理\n• o4-mini（2025-04）— 轻量推理，速度更快，Codex CLI 默认底层模型\n\n【Codex 系列（编程专精）】\n• GPT-5.3-Codex（2026-02）— 最新 Agentic 编码旗舰，在 GPT-5.2-Codex 基础上全面提升编程与专业 Agent 能力\n• GPT-5.2-Codex — 上一代 Codex，仍在 Codex CLI 中广泛使用",
      function: "核心能力",
      functionContent: "• GPT-5：统一通用推理 + 多模态，内置思考链，代替 o1 的「慢思考」与 GPT-4o 的「快答」\n• o3 系列：超强 Chain-of-Thought，数学证明、代码竞赛级能力\n• GPT-5.3-Codex：专为 Agentic 编程任务设计，计算机操作 + 多步 Agent 规划\n• Function Calling / Structured Outputs：业界最成熟的工具调用 API 和 JSON 输出\n• Codex CLI：openai/codex 开源 CLI，底层可接 o4-mini 或 GPT-5.3-Codex",
      scenario: "典型使用场景",
      scenarioContent: "• Codex CLI 默认底层模型（o4-mini），也可升级到 GPT-5.3-Codex\n• 复杂推理和数学：o3/o3-pro 系列用于数学竞赛、科研分析\n• 通用问答和写作：GPT-5 / GPT-5 mini 用于日常助手\n• 代码生成与 Agent：GPT-5.3-Codex 是 Agentic 编程首选\n• 企业级集成：Azure OpenAI 服务，合规部署",
      relation: "与其他生态关系",
      relationContent: "• OpenAI API 是行业事实标准，大多数第三方代理（PackyCode、Kimi 等）均兼容其接口\n• Codex CLI 默认使用 o4-mini，也支持 GPT-5.3-Codex\n• 本平台支持将 OpenAI 兼容接口配置为自定义 Provider",
    },
    google: {
      title: "Google Gemini 系列",
      subtitle: "原生多模态 + Gemini 3 Deep Think（2026）",
      definition: "模型家族概述（2026 年最新）",
      definitionContent: "Google DeepMind 的 Gemini 系列原生多模态，2026 年重大升级：\n\n• Gemini 3 Deep Think（2026-02）— 全新升级，专为科学/研究/工程前沿挑战设计，融合科学知识与工程实用性，超越抽象理论进入实际应用\n• Gemini 2.5 Pro — 高级推理旗舰，100 万 token 上下文（实验版 200 万），Vertex AI 正式可用\n• Gemini 2.5 Flash — 速度/价格最优，仍是高并发首选\n• Gemini 2.0 Flash — 上一代速度王，生产稳定，大量中间件仍在使用\n• Gemini Nano — 端侧轻量模型（Android / Chrome）",
      function: "核心能力",
      functionContent: "• 超长上下文：100 万 tokens（Gemini 2.5 Pro），可分析整个代码仓库或长视频\n• Gemini 3 Deep Think：深度科学推理，突破工程与研究边界\n• 原生多模态：文本、图像、音频、视频、PDF 统一处理\n• Google Search 集成：内置实时搜索增强（Grounding）\n• 代码能力：Gemini 2.5 Pro 在 LiveBench 代码基准接近 Claude Sonnet\n• Google Workspace 集成：与 Docs/Sheets/Gmail 深度集成",
      scenario: "典型使用场景",
      scenarioContent: "• Gemini CLI 的底层模型（免费额度：60 次/分钟，1000 次/天）\n• 科学与研究前沿：Gemini 3 Deep Think 适合复杂工程与科研分析\n• 超长文档分析：视频理解、多文档对比\n• Google 生态集成：Workspace 智能助手\n• 多模态任务：图表解读、代码截图分析",
      relation: "与其他生态关系",
      relationContent: "• Gemini CLI 的官方默认模型（Gemini 3 系列）\n• 本平台 Gemini CLI Provider 对应 Google AI Studio API 或 Vertex AI\n• 通过 GOOGLE_API_KEY / GEMINI_API_KEY 环境变量配置",
    },
    meta: {
      title: "Meta Llama 系列",
      subtitle: "最具影响力的开源大模型（2026 最新）",
      definition: "模型家族概述（2026 年最新）",
      definitionContent: "Meta 的 Llama 系列是最重要的开源大模型家族，2025-2026 年持续迭代：\n\n• Llama 4（2026）— 新一代旗舰，多模态能力显著提升，更强的推理与 Agent 能力\n• Llama 3.3 70B — 当前最广泛使用的开源版本，接近 GPT-4o 水平\n• Llama 3.1 405B — 超大参数量，开源中的顶级水准\n• Llama 3.2（多模态）— 支持图像理解，有 1B/3B 轻量版\n• Code Llama — 针对代码优化的衍生版本",
      function: "核心能力",
      functionContent: "• 完全开源：权重可商用下载，支持本地部署\n• 微调友好：LoRA / QLoRA 微调成本极低\n• 工具调用：Llama 3.1+ 支持 Function Calling\n• 多尺寸选择：1B 到 405B+ 全覆盖，适配不同硬件\n• 活跃社区：Ollama、LM Studio、vLLM 等大量工具支持\n• Llama 4：多模态 + 增强 Agent 支持",
      scenario: "典型使用场景",
      scenarioContent: "• 本地私有部署：Ollama + Llama 3.3 70B，完全离线运行\n• 企业私有化：数据不出内网，符合合规要求\n• 微调定制：在特定领域数据上微调，打造专业模型\n• 开发者研究：学习大模型原理和实验",
      relation: "与其他生态关系",
    ...
    chinese: {
      title: "中国主流大模型",
      subtitle: "国产头部大模型产品线对比（2026 最新）",
      definition: "主要厂商概述（2026 年最新）",
      definitionContent: "中国大模型生态持续高速发展，春节前后（2026.02）多款新模型相继发布：\n\n【阿里 Qwen（通义）系列】\n• Qwen3 — 最新旗舰，全面超越 Qwen2.5，推理与代码能力大幅提升\n• Qwen2.5 / Qwen2.5-Coder — 仍被广泛使用的上一代版本\n• QwQ — 推理增强版，针对数学和逻辑任务优化\n\n【DeepSeek 系列】\n• DeepSeek R2 — 最新旗舰推理模型，超越 R1，接近顶级闭源模型\n• DeepSeek V3.2 — 通用旗舰升级版，性价比极高\n• DeepSeek-R1 — 上一代推理模型，完全开源\n\n【Kimi（月之暗面）系列】\n• kimi-for-coding — Claude Code / Codex 兼容代理，本平台内置模板\n• Moonshot v1 — 通用模型\n\n【其他】\n• 百度文心 4.5、智谱 GLM-4、MiniMax-Text-01、混元大模型 等",
      function: "核心优势",
      functionContent: "• 价格优势：多数国产模型 API 价格远低于 OpenAI，DeepSeek V3.2 几乎是业界最低成本\n• 中文能力：在中文理解、生成和文化适配上表现出色\n• 开源生态：DeepSeek R2、Qwen3 等完全开源，支持本地部署\n• 合规友好：数据存储在国内，满足数据主权要求\n• 推理突破：DeepSeek R2 / QwQ 等推理能力已接近 o3 水平",
      scenario: "典型使用场景",
      scenarioContent: "• kimi-for-coding：直接替代 Claude API，用于 Claude Code 本地开发\n• DeepSeek V3.2：高性价比通用任务，支持 Function Calling\n• Qwen3 / Qwen2.5-Coder：代码生成和审查，中文注释友好\n• 企业私有化：Qwen3 / DeepSeek 本地部署，数据不出境",
      relation: "与本平台关系",
    ...
    specialized: {
      title: "专用与前沿模型",
      subtitle: "垂直领域与新兴架构的代表模型（2026）",
      definition: "分类概述（2026 年最新）",
      definitionContent: "除通用大模型外，还有一批针对特定领域或采用新型架构的前沿模型：\n\n【Agentic 编程专精】\n• GPT-5.3-Codex（OpenAI，2026-02）— 最新 Agentic 编码旗舰，专为多步 Agent 任务优化\n• Claude Opus 4.6（Anthropic，2026-02）— 大型代码库长 Agent 任务首选\n• GitHub Copilot（GPT-5 驱动）— 最广泛使用的代码补全工具\n\n【多模态前沿】\n• GPT-5（实时模式）— 内置思考链 + 实时多模态\n• Gemini 3 Deep Think — 科学/研究/工程深度推理\n• Claude Sonnet 4.6 — Computer Use 能力大幅提升\n\n【推理增强型】\n• OpenAI o3 / o3-pro — 深度 Chain-of-Thought，数学科学顶尖\n• DeepSeek R2 — 开源推理旗舰，接近 o3\n• QwQ（Qwen 推理版）— 中文推理首选\n\n【小型高效模型】\n• Phi-4（Microsoft）— 140 亿参数，推理超越更大模型\n• Gemma 3（Google，2026）— 新一代开源小模型\n• Mistral Small 3 — 高效多语言轻量模型",
      function: "选型指南（2026）",
      functionContent: "如何根据场景选择合适的模型：\n\n• 需要最强推理/数学 → OpenAI o3-pro / DeepSeek R2\n• 最强 Agentic 编码 → Claude Opus 4.6 / GPT-5.3-Codex\n• 超长文档处理 → Gemini 2.5 Pro（100 万 token）/ Claude Sonnet 4.6（1M Beta）\n• 本地私有部署 → Llama 4 / Qwen3 / DeepSeek V3.2\n• 最低成本 API → DeepSeek V3.2 / Gemini 2.5 Flash / Qwen3\n• 中文最优 → Qwen3 / DeepSeek V3.2 / Kimi\n• CLI 编程助手 → Claude Code（Sonnet 4.6）/ Codex（o4-mini/GPT-5.3-Codex）",
      scenario: "前沿趋势（2026）",
      scenarioContent: "• 1M token 上下文普及：Claude Sonnet/Opus 4.6、Gemini 2.5 Pro 均已支持百万 token\n• Agentic 编程专精化：GPT-5.3-Codex / Claude Opus 4.6 专为长 Agent 任务优化\n• 推理模型进入主流：o3/DeepSeek R2/QwQ 已融入日常开发流程\n• 开源全面追平闭源：Qwen3 / DeepSeek R2 在推理和代码上已达闭源顶级水准\n• 科学研究 AI 崛起：Gemini 3 Deep Think 等针对科学前沿挑战专项突破",
      relation: "生态兼容性",
